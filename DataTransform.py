...
spark.sparkContext.addPyFile("s3://iswarya-landingbucket-batch01/delta-core_2.12-1.2.0.jar")

# Define the configuration file path
config_file_path = "s3://iswarya-rawbucket-batch01/app.json"
...
partitions=config_df.select("partitions").first()[0]

filename=source_path.split('/')[-1]
print(filename)
deltatablepath="s3://iswarya-stagingbucket-batch01/deltatable/"
